...
document.addEventListener('DOMContentLoaded', function () {
	...
	// Radial Chart
	if (document.getElementById('customer-chart')) {
		var radialChart = {
			chart: {
				height: '150px',
				width: '100%',
	...
	if (document.getElementById('sales-purchase')) {
		var sColStacked = {
			chart: {
				height: 245,
				type: 'bar',
	...
	if (document.getElementById('sales-daychart')) {
		var sColStacked = {
			chart: {
				height: 245,
				type: 'bar',
	...
	if (document.getElementById('sales-weekchart')) {
		var sColStacked = {
			chart: {
				height: 245,
				type: 'bar',
	...
	if (document.getElementById('sales-monthchart')) {
		var sColStacked = {
			chart: {
				height: 245,
				type: 'bar',
	...
	if (document.getElementById('sales-quarterchart')) {
		var sColStacked = {
			chart: {
				height: 245,
				type: 'bar',
	...
	if (document.getElementById('sales-halfchart')) {
		var sColStacked = {
			chart: {
				height: 245,
				type: 'bar',
	...
	if (document.getElementById('sales-statistics')) {
		var options = {
			series: [{
				name: 'Revenue',
